 ...
 ************************************************************************************/
package org.jboss.tools.sourcecontainer.internal.containers;
...
import org.jboss.tools.sourcecontainer.SourceContainerActivator;
 ...
 *
 */
public class JBossProjectSourceContainer extends ProjectSourceContainer {
	...
	public JBossProjectSourceContainer(IProject project, boolean referenced) {
		...
		Job job = new Job("Downloading sources for " + file.getName()) {
			...
			public IStatus run(IProgressMonitor monitor) {
				try {
					...
					SourceContainerActivator.log(e);
				}

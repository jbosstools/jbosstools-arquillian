 ...
 ************************************************************************************/
package org.jboss.tools.sourcecontainer.internal.containers.browsers;
...
import org.jboss.tools.sourcecontainer.internal.containers.JBossProjectSourceContainer;
		...
		if(dialog.open() == Window.OK){		
			...
			for (int i= 0; i < elements.length; i++) {
				if(!(elements[i] instanceof IProject))
					continue;				
				res.add(new JBossProjectSourceContainer((IProject)elements[i], ((ProjectSourceContainerDialog)dialog).isAddRequiredProjects()));				
			}

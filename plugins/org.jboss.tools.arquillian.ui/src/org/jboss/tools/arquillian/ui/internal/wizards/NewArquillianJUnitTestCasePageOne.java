...
/**
 * The class <code>NewArquillianJunitTestCasePageOne</code> contains controls and validation routines
 * for the first page of the  'New Arquillian JUnit Test Case Wizard'.
 *
 * Based on org.eclipse.jdt.junit.wizards.NewTestCaseWizardPageOne
 *
 */
public class NewArquillianJUnitTestCasePageOne extends NewTypeWizardPage {
	...
	private final static String STORE_DEPLOYMENT= PAGE_NAME + ".USE_DEPLOYMENT"; //$NON-NLS-1$
	...
	public NewArquillianJUnitTestCasePageOne(NewTestCaseWizardPageTwo page2, NewArquillianJUnitTestCaseDeploymentPage page3) {
		...
		String[] buttonNames= new String[] {
			...
			/* IDX_DEPLOYMENT */ "createDeployment()"
		};
	...
	private boolean isDefaultSuperClass() {
		...
		return superClass.equals("java.lang.Object"); //$NON-NLS-1$
	}
	...
	private void createSetupStubs(IType type, String methodName, boolean isStatic, String annotationType, ImportsManager imports) throws CoreException {
		...
		String annotation= '@' + imports.addImport(annotationType);
	...
	private void restoreWidgetValues() {
		...
		if (settings != null) {
			...
			fMethodStubsButtons.setSelection(IDX_DEPLOYMENT, true); //constructor
		}
	}
	...
	private void saveWidgetValues() {
		...
		if (settings != null) {
			...
			settings.put(STORE_DEPLOYMENT, fMethodStubsButtons.isSelected(IDX_DEPLOYMENT));
		}
	}

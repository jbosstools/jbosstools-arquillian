 ...
 *
 */
public class AddProfilesWizard extends RefactoringWizard {
	 ...
	 * @param refactoring
	 */
	public AddProfilesWizard(AddProfilesRefactoring refactoring) {
	...
	protected void addUserInputPages() {
		...
		addPage(new AddProfilesWizardPage(refactoring));
	}
